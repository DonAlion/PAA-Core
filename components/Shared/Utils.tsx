...
export function G_GET_NOTES_MAP(
  props: NotesMapProps,
  updatePage: Function
): React.ReactNode {
  ...
  // Typings are wrong here. Dev tools shows that pageSize is an int, so convert.
  let pageSize: number = parseInt(props.pageSize.value);
  ...
  return (
    <div>
      {getPaginationControl(props, updatePage, maxPages)}
